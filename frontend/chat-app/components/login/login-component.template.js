...
export function createLoginTemplate(errorMessage, email, password) {
  return `
   ...
   <div class="login-page">
    <h3>Log in</h3>
      <div class="login-form">
        <div>
          <input id="email" value="${email}"  class="login-form__input" type="text" placeholder="email" required/>
        </div>
        <div>
          <input id="password" value="${password}"  class="login-form__input" type="password" placeholder="password" required />
        </div>

...
export class VirtualScroll extends HTMLElement {
  ...
  carriedPrependList() {
    ...
    this.#observedEndIndex = Math.max(0, this.#observedEndIndex - this.#list.children.length + ELEMENTS_GAP);

    this.#observedEndIndex = this.#nodeList.length - this.#list.childElementCount + ELEMENTS_GAP;
    this.#observeElement = this.shadowRoot.querySelectorAll("messages-by-user")[ELEMENTS_GAP];

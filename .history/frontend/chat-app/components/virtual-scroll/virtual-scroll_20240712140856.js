...
export class VirtualScroll extends HTMLElement {
  ...
  async handleScroll() {
    ...
    const changeTo = Math.ceil((scrollTop + visibleHeight) / this.#rowHeight);
    this.#startIndex = scrollTop >= this.#viewportHeight ? changeTo + this.#startIndex : this.#startIndex - changeTo;

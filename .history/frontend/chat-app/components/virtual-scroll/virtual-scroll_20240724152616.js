...
export class VirtualScroll extends HTMLElement {
  ...
  indexItems() {
    ...
    this.itemHeights.forEach((item, index) => this.itemHeights[index] = this.getItemHeight(index))
  ...
  getAccumulatedHeight(startIndex, endIndex) {
    return this.itemHeights.slice(startIndex, endIndex).reduce((sum, height) => sum + height, 0);
}

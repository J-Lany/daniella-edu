...
export class VirtualScroll extends HTMLElement {
  ...
  getStartIndex(scrollTop) {
    return this.itemHeights.reduce((acc, itemHeight, index) => {
        const totalHeight = acc + this.getItemHeight(index);
        return totalHeight > scrollTop ? Math.max(0, index - this.bufferSize) : acc;
    }, 0);
}

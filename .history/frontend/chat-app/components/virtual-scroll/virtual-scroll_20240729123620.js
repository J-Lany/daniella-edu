...
export class VirtualScroll extends HTMLElement {
  ...
  #setCustomComponent(newValue) {
    ...
    if (component) {
      ...
      component.setAttribute('total-items', totalItems.toString());
      component.setAttribute('start-index', startIndex.toString());
      component.setAttribute('end-index', endIndex.toString());

...
export class VirtualScroll extends HTMLElement {
  ...
  observeIntersection() {
    ...
    observer.observe(this.#list[this.#observedEndIndex]);
  }
  ...
  loadMoreItems() {
    ...
    if (this.#observedEndIndex > this.#buffer) {
      for (let i = this.#observedEndIndex; i > this.#observedEndIndex - this.#buffer; i--) {
        this.#list.prepend(this.#nodeList[i].cloneNode(true));
      }
      this.#observedEndIndex -= this.#buffer;
    }

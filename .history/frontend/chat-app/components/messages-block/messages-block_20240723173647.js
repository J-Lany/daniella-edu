...
export class MessagesBlock extends HTMLElement {
  ...
  async loadMoreMessages() {
    ...
    historyMessagrs.forEach((messageBlock) => {
      const templateElem = document.createElement("messages-by-user");
      templateElem.setAttribute("messages", JSON.stringify(messageBlock));
      newMessagesElements.push(templateElem);
    });

    ...
    newMessages.reduce((accumulator, innerArray) => {
      innerArray.forEach((newMessage) => {
        ...
        if (existingMessageIndex !== -1) {
          const innerIndex = accumulator[existingMessageIndex].findIndex(
            (existingMessage) =>
              existingMessage.messageId === newMessage.messageId
          );
          accumulator[existingMessageIndex][innerIndex] = newMessage;
        } else {
